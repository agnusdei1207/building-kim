...
public class CmmnDefaultVO implements Serializable {
	 ...
	 * </pre>
	 *
	 * @param pRecordCountPerPage
	 *            를 설정한다.될 recordCountPerPage
	 */
	 ...
	 */
	/*
	 * public void setLoginId(final String pLoginId) { this.loginId = pLoginId;
	 * }
	 */
	/**
	 * @return LoginNm
	 ...
	 */
	/*
	 * public void setLoginNm(final String pLoginNm) { this.loginNm = pLoginNm;
	 * }
	 */
	// User Auth
	/**
	 ...
	 */
	/*
	 * public List<String> getLoginAutho() { List<String> listAuth = new
	 * ArrayList<String>();
	 * 
	 * Authentication authentication =
	 * SecurityContextHolder.getContext().getAuthentication(); if
	 * (authentication != null) { Collection<? extends GrantedAuthority>
	 * authorities = authentication.getAuthorities();
	 * 
	 * Iterator<? extends GrantedAuthority> iter = authorities.iterator();
	 * 
	 * while (iter.hasNext()) { GrantedAuthority auth = iter.next();
	 * listAuth.add(auth.getAuthority()); } return listAuth; } else { return
	 * null; } }
	 */
	...
	public String toString() {
		return "SearchVO [pageIndex=" + pageIndex + ", searchCondition=" + searchCondition + ", searchKeyword="
				+ searchKeyword + ", searchDispYn=" + searchDispYn + ", pageUnit=" + pageUnit + ", pageSize=" + pageSize
	...
	/**
	 * @param pSchCategoryCd
	 *            the schCategoryCd to set
	 */
	...
	public String getFrontLoginSeq() throws Exception {
		if (SessionUtil.getFtUserDetails() != null) {
			return StringUtil.nullString(SessionUtil.getFtUserDetails().getMeSeq());
		} else {
			return "";
		}
	}
