package com.open.ma.kim.estQst;
...
public class EstQstController {
    ...
    /** folderPath **/
    private final static String folderPath = "/ma/kim/estQst/";
	...
	public String proc(@ModelAttribute("searchVO") EstQstVO searchVO, Model model, SessionStatus status,@PathVariable String procType, HttpServletRequest request) throws Exception {
		...
		if(procType != null){
			if (procType.equals("insert")) {
				...
				message = "삭제되었습니다.";
				cmmnScript = "list.do";
			}   else if (procType.equals("updateCmt") ) {				
