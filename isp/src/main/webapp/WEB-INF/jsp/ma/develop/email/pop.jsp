...
<div class="pop_header">  
	<a href="javascript:void(0);" class="pop_close" onclick="view_hide(1);"></a>
</div>  
...
<div class="pop_content">
		...
		<div class="search_box">                              
			<form name="popFrm" id="popFrm" method="post"  onsubmit="return false;"> 
				...
				<input type="hidden" name="popDivn" id="popDivn" value="${searchVO.popDivn }" />      
				<%-- 체크 상태 저장 --%>    
