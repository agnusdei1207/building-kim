...
<input type="text" name="schEtc04" id="schEtc04" value="<c:out value='${searchVO.schEtc04}'/>"/>
<input type="text" name="schEtc05" id="schEtc05" value="<c:out value='${searchVO.schEtc05}'/>"/>
